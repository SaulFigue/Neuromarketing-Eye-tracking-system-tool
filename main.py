...
def main(calibration_matrix_path: str, monitor_mm=None, monitor_pixels=None, model=None, visualize_preprocessing=False, visualize_laser_pointer=True, visualize_3d=False):
    ...
    for frame_idx, frame in enumerate(source):
        ...
        if results.multi_face_landmarks:
            ...
            # Aqui guardo cada coordenada en pxs al archivo gazepoints.csv para plotear el heatmap
            add_gazepoint(point_on_screen)
...
# FOR RUNING DEMO
# python main.py --calibration_matrix_path=./calibration_matrix.yaml --model_path=./ResNet_p00.ckpt
# python main.py --visualize_laser_pointer=True --calibration_matrix_path=./calibration_matrix.yaml --model_path=./ResNet_p00.ckpt
# python main.py --visualize_3d=True --visualize_preprocessing=True --calibration_matrix_path=./calibration_matrix.yaml --model_path=./ResNet_p00.ckpt
