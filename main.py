...
def main(base_path: str, monitor_mm=None, monitor_pixels=None):
    ...
    # --------------------------------------------------------------------------    
    """
    Aqui vendría bien guardar mas parametros como el pitch angle respecto a la camara,
    y la posicion de los ojos en screen coordinates system para asi poder sacar
    la matriz de rotacion R y translacion T. 
    Estas deben ser usadas para generar la ecuacion de mapeo Gaze-to-screen para maor
    precision en el DEMO
    """
    ...
    while True:
        ...
        print('time till capture: ',time_till_capture)
