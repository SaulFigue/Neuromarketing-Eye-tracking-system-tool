...
if __name__ == '__main__':
    ...
    # 2. split video into frames e.g. `ffmpeg -i 2023-02-28_15:38:39.mp4 -f image2 frames/video_01-%07d.png` and delete blurry images
    # 2.1 This is a linux command, I need will use colab for this task
    
    # 3. run calibration on images
    # calibration('./frames', 30, debug=True) #(Uncomment this, and comment 'record_video')
